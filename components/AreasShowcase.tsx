    ...
    <div>
      ...
      <div className="mt-14 flex justify-center">
        <Link href={active.href} className="group w-full">
          <div className="flex min-h-[400px] flex-col items-center justify-center gap-6 rounded-3xl bg-card p-12 text-center shadow-[0_20px_50px_-20px_rgba(0,0,0,0.8)] transition-colors duration-300 ease-out sm:p-16">
            {ActiveIcon && (
