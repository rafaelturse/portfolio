...
export default function EducationCard({ icon: Icon, credential, school, location, text }: EducationCardProps) {
  return (
    <div
    ...
    >
      ...
      {text && (
        <p className="font-body text-sm leading-relaxed text-muted sm:text-base">{text}</p>
      )}
