                ...
                <div className="container mt-5">
                    ...
                    <div className="font-skill tab-content borderless mt-5">
                        <nav className="nav nav-pills flex-column flex-md-row font-pills-title">
                            <a id="interest" className="flex-md-fill text-md-center nav-link m-2 " data-bs-toggle="tab" href="#content-interest"><i className="fas fa-angle-right mr-2"></i>INTEREST</a>
                            <a id="focus" className="flex-md-fill text-md-center nav-link m-2 active" data-bs-toggle="tab" href="#content-focus"><i className="fas fa-angle-right mr-2"></i>FOCUS</a>
                        ...
                        {/* INTEREST */}
                        <div id="content-interest" className="tab-pane fade show " role="tabpanel"><ChartInterest /></div>

                        {/* FOCUS */}
                        <div id="content-focus" className="tab-pane fade show active" role="tabpanel">
                            <div className="container mt-5">
                                <div className="row">
                                    <div className="col mb-3">
                                        ...
                                        {/*
                                            Buscando ser um profissional completo, tenho vasto conhecimento e experiência nas principais áreas de desenvolvimento de software. 
                                            Sou capaz de codificar regras de negócios e utilizar complexos padrões de projetos no backend para fazer com que todo o núcleo do 
                                            sistema condifico e programo backend orientado a objetos e
                                            */}
                                    </div>
